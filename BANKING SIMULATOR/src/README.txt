...
Less important note regarding calendar dates:
	The API we use for historical stock data does not contain data within the past year.
	Because of this, we boot a year and 3 months into the past when we initialize the date
	This is not a bug.
